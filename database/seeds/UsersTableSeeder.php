...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        factory(App\User::class, 20)->create(['type' => 'U','rank' => 1,'avatar' => 'default.png']);
        factory(App\User::class, 15)->create(['type' => 'U','rank' => 2,'avatar' => 'default.png']);
        factory(App\User::class, 10)->create(['type' => 'U','rank' => 3,'avatar' => 'default.png']);
        factory(App\User::class, 8)->create(['type' => 'U','rank' => 4,'avatar' => 'default.png']);
        factory(App\User::class, 5)->create(['type' => 'U','rank' => 5,'avatar' => 'default.png']);

        factory(App\User::class, 100)->create(['avatar' => 'default.png']);

        User::find(1)->followers()->attach([2,3,7,9,14]);
        User::find(2)->followers()->attach([3,8,10,15]);
        User::find(3)->followers()->attach([2,5,6,7,9,10,14,20]);
        User::find(1)->following()->attach([2,4,6,7,15]);
        User::find(2)->following()->attach([4,5,6,9,12]);
        User::find(3)->following()->attach([22,4,5,7,8,9,12,16]);
