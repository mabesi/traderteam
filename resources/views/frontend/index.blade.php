      ...
      <div class="overlay">
          <div class="container">
              <div class="row">
                ...
                <div class="col-md-9">
                  <div class="wow fadeInDown "><img class="site-name" src="{{ asset('backyard/images/site-name.png') }}" alt="logo"></div>
                </div>
              </div>
              <div class="row">
                  <div class="col-md-7">
      ...
      <nav class="navbar-wrapper navbar-default" role="navigation">
          <div class="container">
              <div class="navbar-header">
                  ...
                  <a class="navbar-brand site-name" href="#top"><img src="{{ asset('backyard/images/logo2.png') }}" alt="logo"></a>
              </div>
      ...
      <div class="container">
          <div class="row">
              ...
              <div class="col-md-6 intro-pic wow slideInLeft">
                  <img src="{{ asset('backyard/images/intro-image.jpg') }}" alt="image" class="img-responsive">
              </div>
